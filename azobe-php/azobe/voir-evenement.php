...
<head>
    ...
    <title> Asso Gabon || Dashboard - Description d'événement </title>
    <meta name="viewport"
                        ...
                        <div class="card-body">
                            <div class="text-center" style="margin-bottom: 1.6rem;">
                                <div class="card-header">
                                    <h2><b> DESCRIPTION DE L'EVENEMENT </b></h2>
                                    <div class="btn-actions-pane-right actions-icon-btn">
                                        <!--<button class="btn-icon btn-icon-only btn btn-pill  btn-link"><a href="#" alt="Envoyer un message" title="Envoyer un message"><i class="pe-7s-chat btn-icon-wrapper"> </i></a></button>-->
                                        <!---- <button class="btn-icon btn-icon-only btn btn-pill  btn-link"><a href="https://www.grandpariscirculaire.org/data/exports/pdf/atelier-de-sensibilisation-au-gaspillage-alimentaire-par-biocycle.pdf" target="_blank" alt="Imprimer le document" title="Imprimer le document"><i class="pe-7s-print btn-icon-wrapper"> </i></a></button>-->
                            ...
                            <div class="jumbotron" data-step="1" data-intro="This is a tooltip!">
                                <h1 class="display-4"> Partie réservée pour l'intégration de la vue de l'événement
                                    publié sur le front office du site web </h1>

                                <br>
                                <h4> EXEMPLE :</h4>
                                <p><b>(Secteur:</b> Education</p>
                                <p><b>Edité par:</b> Juste FADIKPE</p>
                                <p><b><i class="fa fa-calendar"></i> Date de début:</b> novembre 2019</p>
                                <p><b><i class="fa fa-map-pin"></i> Lieu:</b> Ogooué Labs</p>
                ...
                <form class="">
                    ...
                    <div class="col-12">
                        ...
                        <div class="custom-control custom-checkbox" style="font-size: 1rem;">
                            ...
                            <label class="custom-control-label" for="defaultUnchecked1"> Absence de documents ; </label>
                            </br>
                            ...
                            <label class="custom-control-label" for="defaultUnchecked5">Absence de documents ;</label>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-body">
                <form class="">
                    <div class="position-relative form-group"><label for="exampleEmail" style="font-size: 20px;">Nom de
                            l'événement</label><input name="title" id="title" placeholder="Entrer le nom de l'événement"
                    ...
                    <div class="position-relative form-group"><label for="exampleFile">Choisir un fichier</label><input
                ...
                <div class="modal-body">
                    <form class="">
                        <div class="position-relative form-group"><label for="exampleEmail"
                                ...
                                document</label><input name="title" id="title" placeholder="Saisir le titre du document"
                                type="text" class="form-control">
                        </div>
            ...
            <div class="modal-body text-center">
                <span class="fa-stack fa-lg text-success"
                    style="font-size: 2rem; margin-bottom: 1.7rem; margin-top: 2rem;"><i
                        class="fa fa-circle fa-stack-2x"></i><i class="fa fa-check fa-stack-1x fa-inverse"></i></span>
